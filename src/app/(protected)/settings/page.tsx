    ...
    <>
      <main className="mx-auto w-full max-w-xl flex-1 px-6 py-8">
        ...
        <section className="mb-8 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
            Manually refresh episode schedules and streaming providers for all monitored shows.
            A nightly cron can call <code className="text-xs">/api/cron/refresh</code>.
          </p>
          <button
            onClick={refreshAll}
            disabled={refreshing}
